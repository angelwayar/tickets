...
class _HomePageState extends State<HomePage> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    dayItem(
                        'assets/images/tony.jpeg', '14', 'FRI', 'Tony Stark'),
                    SizedBox(
                      height: 16.0,
                    ),
                    dayItem(
                        'assets/images/peter.jpg', '15', 'SAT', 'Perte Parker'),
                    SizedBox(
                      height: 16.0,
                    ),
                    dayItem('assets/images/strange.jpg', '16', 'SUN',
                        'Steven Strange'),
                    SizedBox(
                      height: 8.0,
                    )
  ...
  Widget dayItem(String img, String date, String day, String name) {
    return Card(
        elevation: 8.0,
